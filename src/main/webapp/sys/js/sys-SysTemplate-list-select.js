layui.config({
    ...
    +'<td>'
        +  '<a class="layui-btn layui-btn-mini news_edit" tips="'+currData[i].tplId+'"><i class="iconfont icon-edit"></i> 选择</a>'
	...
	function newsList(newsData,tableDom ,renderData_){
		...
		function renderDatas() {
            ...
            tableDom.find('.news_edit').each(function( ){
                var tplId=  $(this).attr("tips");
                $(this).click(function () {

                    parent.selectTemplate(getQueryString("inputId"), tplId);
                });
