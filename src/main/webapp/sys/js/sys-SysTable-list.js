layui.config({
    ...
    +'<td>'
        +  '<a class="layui-btn layui-btn-mini news_edit" tips="'+currData[i].tbId+'" tipse="'+currData[i].tbNam+'"><i class="iconfont icon-edit"></i> 选中</a>'
         +'</td>'
    +'</tr>';
            }
        }else{
	...
	function newsList(newsData,tableDom ,renderData_){
		...
		function renderDatas() {
            ...
            tableDom.find('.news_edit').each(function( ){
                var tabId=$(this).attr("tips");
                var tabName=$(this).attr("tipse");
                $(this).click(function(){
                    parent.setTableNameCallback(tabName,tabId);
                });
            });
